...
def draw_border(ws, cell_range):
    thin = Side(border_style="thin", color="000000")
    fullBorder = Border(top=thin, left=thin, right=thin, bottom=thin)
...
def ConvertColumnName(columnID):
  if(columnID < 27):
    return chr(ord('A') + columnID - 1)
  elif(columnID < 53):
    return "A" + chr(ord('A') + columnID - 27)
  elif(columnID < 79):
    return "B" + chr(ord('A') + columnID - 53)
  elif(columnID < 105):
    return "C" + chr(ord('A') + columnID - 79)
  elif(columnID < 131):
    return "D" + chr(ord('A') + columnID - 105)
  elif(columnID < 157):
    return "E" + chr(ord('A') + columnID - 131)
  elif(columnID < 183):
    return "F" + chr(ord('A') + columnID - 157)
  else:
    return "G" + chr(ord('A') + columnID - 183)